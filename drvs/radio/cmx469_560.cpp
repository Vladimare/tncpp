...
void cmx469_560::pinSetup(bool setDefault)
{
  ...
  coreUnregisterIRQ(IRQ0_EINT1);      /* снимаем прерывания с регистрации               */
